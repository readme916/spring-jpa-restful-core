...
public class RestfulController extends DefaultExceptionHandler{
	...
	public Object get(@PathVariable String resource, @PathVariable String resourceId,
		...
		return getService.fetch(resource, Long.valueOf(resourceId), params);
	}
	...
	public Object get(@PathVariable String resource, @PathVariable String resourceId, @PathVariable String subResource,
			@RequestParam(required = false) HashMap<String, String> params) {
		return getService.fetch(resource, Long.valueOf(resourceId), subResource, params);
	}
	...
	public Object get(@PathVariable String resource, @PathVariable String resourceId, @PathVariable String subResource,
		...
		return getService.fetch(resource, Long.valueOf(resourceId), subResource, Long.valueOf(subResourceId), params);
	}
	...
	public Object get(@PathVariable String resource, @PathVariable String resourceId, @PathVariable String subResource,
			...
			@RequestParam(required = false) HashMap<String, String> params) {
		return getService.fetch(resource, Long.valueOf(resourceId), subResource,  Long.valueOf(subResourceId),subsubResource, params);
	}
	...
	public Object update(@PathVariable String resource, @PathVariable String resourceId,
		...
		return postService.update(resource,  Long.valueOf(resourceId), body);
	}
	...
	public Object sub_create(@PathVariable String resource, @PathVariable String resourceId,
		...
		return postService.create(resource,  Long.valueOf(resourceId), subResource, body);
	}
	...
	public Object sub_update(@PathVariable String resource, @PathVariable String resourceId,
			...
			@RequestBody(required = true) String body) {
		return postService.update(resource,  Long.valueOf(resourceId), subResource,  Long.valueOf(subResourceId), body);
	}
	...
	public Object sub_sub_create(@PathVariable String resource, @PathVariable String resourceId,
		...
		return postService.create(resource, Long.valueOf(resourceId), subResource, Long.valueOf(subResourceId), subsubResourceProperty, body);
	}
	...
	public Object delete(@PathVariable String resource, @PathVariable String resourceId) {
		return deleteService.delete(resource, Long.valueOf(resourceId));
	}
	...
	public Object sub_update(@PathVariable String resource, @PathVariable String resourceId,
			@PathVariable String subResource, @PathVariable String subResourceId) {
		return deleteService.delete(resource, Long.valueOf(resourceId), subResource, Long.valueOf(subResourceId));
	}
}